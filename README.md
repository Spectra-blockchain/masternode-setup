...
4. Send 1000 SPC to this address and wait for at least 1 confirmation
...
```
bash <( curl -sL https://raw.githubusercontent.com/Spectra-blockchain/masternode-setup/main/masternodeinstall.sh)
```
...
```<alias> <ip>:17000 <private_key> <tx_id> <index>```
3. It should look something like this:
``` MN1 127.0.0.2:17000 XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX X```
...
3. Enter ```spectra-cli getmasternodestatus```
